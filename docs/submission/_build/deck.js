...
(async () => {
  ...
  // ── 9. Демо ──────────────────────────────────────────────────────
  {
    ...
    T(s, "Живой звонок: от конца фразы до тревоги 3,3 с на процессоре ноутбука   ·   Видео-демо: [ссылка]   ·   Код: github.com/daurenoralbek/qalqan",
    ...
    s.addNotes("Вот как это выглядит. Мошенник представляется техподдержкой и предлагает вернуть деньги за двойное списание. " +
      ...
      "громкой связи, ноутбук слушает, распознаёт речь и пересчитывает риск — от конца фразы до тревоги около трёх секунд.");
  }
